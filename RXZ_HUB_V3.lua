...
local function applyBackgroundImage(index)
    ...
    if backgroundIndex == 0 then
        ...
        if imgId then
            ...
            bgImageRef.ImageTransparency = 0.45
...
RXZ.buildLagger=function()
    ...
    bgImg.Image="rbxassetid://114782221998545"; bgImg.ScaleType=Enum.ScaleType.Crop; bgImg.ImageTransparency=0.7
...
;(function()
    ...
    BgImg.Image="rbxassetid://114782221998545"; BgImg.ScaleType=Enum.ScaleType.Crop; BgImg.ZIndex=0
